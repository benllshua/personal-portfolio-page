        ...
        <g transform="translate(-825.000000, -1100.000000)" id="avatarmaker/Circle">
          <g transform="translate(825.000000, 1100.000000)">
            <g id="Circle" strokeWidth="1" fillRule="evenodd" transform="translate(12.000000, 40.000000)">
              ...
              <use id="Circle-Background" fill="#E6E6E6" xlinkHref="#path-1"></use>
              <g id="ColorPaletteBlue01" mask="url(#mask-2)" fill="#65C9FF" style={{ fill: color.primary }}>
            ...
            <g id="avatarmaker" strokeWidth="1" fillRule="evenodd" mask="url(#mask-4)">
              ...
              <g id="Top" strokeWidth="1" fillRule="evenodd">
                ...
                <mask id="react-mask-58" fill="white">
                  <use xlinkHref="#react-path-60"></use>
                </mask>
                <g id="Mask"></g>
                <g id="Top/Short-Hair/Short-Flat" mask="url(#react-mask-58)">
                  <g transform="translate(-1.000000, 0.000000)">
                    <mask id="react-mask-57" fill="white">
                      <use xlinkHref="#react-path-59"></use>
                    </mask>
                    <use
                      id="Short-Hair"
                      stroke="none"
